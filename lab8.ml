...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let new_identity = new_id () in
    let listener_waiter = {id = new_identity; action = listener} in
    evt := listener_waiter :: !evt ;
    new_identity ;;
  ...
  let rec remove_listener (evt : 'a event) (i : id) : unit =
    ...
    | h :: t ->
      if h.id = i then
        ...
        let tail_evt = ref t in
        remove_listener tail_evt i ;
        evt := h :: !tail_evt ;;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let fire_waiter (waiter : 'a waiter) (a : 'a) : unit =
      waiter.action a
    in
    let rec fire_waiter_list (waiter_list : 'a waiter list) (a : 'a) : unit =
      match waiter_list with
      | [] -> ()
      | h :: t ->
        fire_waiter h a ;
        fire_waiter_list t a
    in
    fire_waiter_list !evt arg ;;
...
newswire.add_listener fakeNewsNetwork new_event;
newswire.add_listener buzzFake new_event;
...
(* let _ = fire_event fakeNewsNetwork h1 ;; *)
